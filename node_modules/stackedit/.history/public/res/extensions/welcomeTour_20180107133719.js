		...
		tour.addSteps([
			{
				...
				content: [
					...
					'<p>If you want to migrate, <a href="#" class="action-export-docs-tour">click here</a> to export a backup of your files and <a href="app" target="_blank">click here</a> to open the new version.</p>',
