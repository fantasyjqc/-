		...
		tour.addSteps([
			{
				...
				content: [
					'<p>StackEdit 5 is now ready for production. <a href="app" target="_blank">you can try it here</a>!</p>',
					'<p>If you want to migrate, click here to export a backup of your files and <a href="app" target="_blank">click here</a> to open the new version.</p>',
					'You can always click <b>Finish</b> to go continue with StackEdit 4.'
				].join(""),
				placement: 'bottom'
			},
		]);
